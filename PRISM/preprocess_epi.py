...
from PRISM.utils import split_adata_ob
...
#         sc.pp.pca(ad_concat, n_comps=min(30, ad_concat.n_vars-1))
#         tmp_key = 'X_pca'
#     else:
...
#         transformer = lsiTransformer(n_components=30, drop_first=False, log=True, norm=True, z_score=True, tfidf=False, svd=True, pcaAlgo='arpack')
